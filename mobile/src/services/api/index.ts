...
const events: event[] = [
  {
    id: 'e1',
    title: 'Clean your Air Fryer',
    subtitle: 'Oil buildup slows it down',
    productId: 'p2',
    action: 'care',
  ...
  {
    id: 'e2',
    title: 'Coffee Machine repair open',
    subtitle: 'Grinder jam, 38 days unresolved',
    productId: 'p1',
    action: 'repair',
  ...
  {
    id: 'e3',
    title: 'Microwave sitting unused',
    subtitle: 'No activity, give it a next life',
    productId: 'p3',
    action: 'nextLife',
